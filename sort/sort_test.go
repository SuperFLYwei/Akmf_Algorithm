...
func testIntFramework(t *testing.T, sortingFunction func([]int) []int) {
	sortTests := []struct {
		input    []int
		expected []int
		name     string
...
func testFloat32Framework(t *testing.T, sortingFunction func([]float32) []float32) {
	sortTests := []struct {
		input    []float32
		expected []float32
		name     string
